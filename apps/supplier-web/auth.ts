...
/**
 * This app's Auth.js instance — the supplier workspace.
 *
 ...
 * (`autoworkshop-supplier-web`); there is nothing per-app to configure here.
 *
 ...
 */
const instance: WorkspaceAuth = workspaceAuth('supplier');
