...
/**
 * `/fleet/service-management/repairs-in-progress` — slice 20.
 *
...
export default async function Page() {
  await requireNavRoute('fleet', '/service-management/repairs-in-progress');
  return (
    <FleetRequestView
      filter="in_progress"
      title="Repairs in Progress"
      description="Work a workshop has accepted and not yet completed."
    />
  );
}
