...
import { FleetVehiclesScreen } from '../../_screens/fleet-screens';

/**
 * `/fleet/fleet-assets/vehicles` — slice 20.
 *
...
export default async function Page() {
  await requireNavRoute('fleet', '/fleet-assets/vehicles');
  return <FleetVehiclesScreen />;
}
