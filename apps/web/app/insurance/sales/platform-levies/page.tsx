...
import { PlatformLeviesScreen } from '../../_screens/platform-levies-screen';

/**
 * `/insurance/sales/platform-levies`
 *
...
export default async function Page() {
  await requireNavRoute('insurance', '/sales/platform-levies');
  return <PlatformLeviesScreen />;
}
