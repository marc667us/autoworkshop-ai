...
import { PoliciesSoldScreen } from '../../_screens/policies-sold-screen';

/**
 * `/insurance/sales/policies-sold`
 *
...
export default async function Page() {
  await requireNavRoute('insurance', '/sales/policies-sold');
  return <PoliciesSoldScreen />;
}
