...
/**
 * /requests-and-reception/register-vehicle
 *
 * The §47 MANAGER tree's route, matching its register-customer sibling.
 *
...
const ROUTE = '/requests-and-reception/register-vehicle';
