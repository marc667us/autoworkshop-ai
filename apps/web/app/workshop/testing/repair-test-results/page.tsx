...
/**
 * /testing/repair-test-results — the §49 TECHNICIAN tree. §49 splits one test session into four entries — results, scan, road test and submission — and they are FACETS of one record, so all four open the same screen. A submission page that could not show what is being submitted would be worse than none.
 *
...
export default async function Page() {
  ...
  return <TestingQueueScreen route="/testing/repair-test-results" />;
}
