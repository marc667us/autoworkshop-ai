...
/**
 * `/reports/technician-workload` - "Technician Workload". Slice 8 of `COMPLETION_PLAN.md`.
 *
...
const ROUTE = '/reports/technician-workload';

export default async function Page() {
  await requireNavRoute('workshop', ROUTE);
  return <ReportScreen route={ROUTE} reportKey="technician-workload" fallbackTitle="Technician Workload" />;
}
