...
/**
 * `/reports/financial` - "Financial". Slice 8 of `COMPLETION_PLAN.md`.
 *
 * Renders report `finance`. Fourteen report routes map onto NINE distinct
...
const ROUTE = '/reports/financial';

export default async function Page() {
  await requireNavRoute('workshop', ROUTE);
  return <ReportScreen route={ROUTE} reportKey="finance" fallbackTitle="Financial" />;
}
