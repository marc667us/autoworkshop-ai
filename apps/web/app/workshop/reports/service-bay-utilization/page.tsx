...
/**
 * `/reports/service-bay-utilization` - "Service Bay Utilization". Slice 8 of `COMPLETION_PLAN.md`.
 *
...
const ROUTE = '/reports/service-bay-utilization';

export default async function Page() {
  await requireNavRoute('workshop', ROUTE);
  return <ReportScreen route={ROUTE} reportKey="service-bay-utilization" fallbackTitle="Service Bay Utilization" />;
}
