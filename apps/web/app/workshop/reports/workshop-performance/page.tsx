...
/**
 * `/reports/workshop-performance` - "Workshop Performance". Slice 8 of `COMPLETION_PLAN.md`.
 *
...
const ROUTE = '/reports/workshop-performance';

export default async function Page() {
  await requireNavRoute('workshop', ROUTE);
  return <ReportScreen route={ROUTE} reportKey="job-progress" fallbackTitle="Workshop Performance" />;
}
