...
/**
 * `/reports/delayed-jobs` - "Delayed Jobs". Slice 8 of `COMPLETION_PLAN.md`.
 *
 * Renders report `delayed-jobs`. Fourteen report routes map onto NINE distinct
...
const ROUTE = '/reports/delayed-jobs';

export default async function Page() {
  await requireNavRoute('workshop', ROUTE);
  return <ReportScreen route={ROUTE} reportKey="delayed-jobs" fallbackTitle="Delayed Jobs" />;
}
