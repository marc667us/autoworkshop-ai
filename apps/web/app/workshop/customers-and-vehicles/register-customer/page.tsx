...
/**
 * /customers-and-vehicles/register-customer
 *
 * The §46 OWNER tree's route. CAN_CREATE_CUSTOMER has always included workshop_owner; only reception's tree carried the entry.
 *
...
const ROUTE = '/customers-and-vehicles/register-customer';
