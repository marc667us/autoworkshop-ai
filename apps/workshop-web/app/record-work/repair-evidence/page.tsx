...
/**
 * /record-work/repair-evidence — the §49 TECHNICIAN tree — the same repair record, entered by its evidence.
 *
...
export default async function Page() {
  ...
  return <ExecutionQueueScreen route="/record-work/repair-evidence" />;
}
