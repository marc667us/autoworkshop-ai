...
/**
 * /repair-control/customer-approval/<id> — one customer proposal. the §46 WORKSHOP OWNER tree.
 *
...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  await requireNavRoute('workshop', '/repair-control/customer-approval');
  const { id } = await params;
  return <ProposalSheetScreen route="/repair-control/customer-approval" proposalId={id} />;
}
