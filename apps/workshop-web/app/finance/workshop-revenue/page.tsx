...
/**
 * /finance/workshop-revenue — "Workshop Revenue".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/finance/workshop-revenue');
  return <PlannedScreen route="/finance/workshop-revenue" title="Workshop Revenue" />;
}
