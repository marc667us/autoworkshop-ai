...
/**
 * /vehicle-intake/receive-vehicle — "Receive Vehicle".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/vehicle-intake/receive-vehicle');
  return <PlannedScreen route="/vehicle-intake/receive-vehicle" title="Receive Vehicle" />;
}
