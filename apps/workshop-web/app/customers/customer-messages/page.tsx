...
/**
 * /customers/customer-messages — "Customer Messages".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/customers/customer-messages');
  return <PlannedScreen route="/customers/customer-messages" title="Customer Messages" />;
}
