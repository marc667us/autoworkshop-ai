...
/**
 * /parts-and-suppliers/procurement — "Procurement".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/parts-and-suppliers/procurement');
  return <PlannedScreen route="/parts-and-suppliers/procurement" title="Procurement" />;
}
