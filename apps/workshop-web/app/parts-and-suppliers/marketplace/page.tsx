...
/**
 * /parts-and-suppliers/marketplace — "Marketplace".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/parts-and-suppliers/marketplace');
  return <PlannedScreen route="/parts-and-suppliers/marketplace" title="Marketplace" />;
}
