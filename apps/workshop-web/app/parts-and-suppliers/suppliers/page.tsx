...
/**
 * /parts-and-suppliers/suppliers — "Suppliers".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/parts-and-suppliers/suppliers');
  return <PlannedScreen route="/parts-and-suppliers/suppliers" title="Suppliers" />;
}
