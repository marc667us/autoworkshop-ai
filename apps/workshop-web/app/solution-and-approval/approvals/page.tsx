...
/**
 * /solution-and-approval/approvals — "Approvals".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/solution-and-approval/approvals');
  return <PlannedScreen route="/solution-and-approval/approvals" title="Approvals" />;
}
