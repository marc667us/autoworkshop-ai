...
/**
 * /solution-and-approval/solution-studio — "Solution Studio".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/solution-and-approval/solution-studio');
  return <PlannedScreen route="/solution-and-approval/solution-studio" title="Solution Studio" />;
}
