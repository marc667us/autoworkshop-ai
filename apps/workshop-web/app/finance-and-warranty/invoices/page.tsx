...
/**
 * /finance-and-warranty/invoices — "Invoices".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/finance-and-warranty/invoices');
  return <PlannedScreen route="/finance-and-warranty/invoices" title="Invoices" />;
}
