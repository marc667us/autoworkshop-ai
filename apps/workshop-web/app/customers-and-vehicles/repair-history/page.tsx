...
/**
 * /customers-and-vehicles/repair-history — "Repair History".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/customers-and-vehicles/repair-history');
  return <PlannedScreen route="/customers-and-vehicles/repair-history" title="Repair History" />;
}
