...
/**
 * /customers-and-vehicles/customers/<id> — detail, on the §46 owner tree.
 *
 * ⚠️ GATED ON THE PARENT LIST ROUTE, not on this one. A detail route is DYNAMIC
 * and no navigation advertises one entry per record, so "is `/customers-and-vehicles/customers/<id>`
...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <CustomerDetailScreen id={id} listHref="/customers-and-vehicles/customers" />;
}
