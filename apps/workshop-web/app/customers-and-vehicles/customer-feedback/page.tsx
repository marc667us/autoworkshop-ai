...
/**
 * /customers-and-vehicles/customer-feedback — "Customer Feedback".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/customers-and-vehicles/customer-feedback');
  return <PlannedScreen route="/customers-and-vehicles/customer-feedback" title="Customer Feedback" />;
}
