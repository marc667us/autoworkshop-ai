...
/**
 * /knowledge-and-staff/repair-knowledge — "Repair Knowledge".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/knowledge-and-staff/repair-knowledge');
  return <PlannedScreen route="/knowledge-and-staff/repair-knowledge" title="Repair Knowledge" />;
}
