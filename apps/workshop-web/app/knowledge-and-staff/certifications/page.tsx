...
/**
 * /knowledge-and-staff/certifications — "Certifications".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/knowledge-and-staff/certifications');
  return <PlannedScreen route="/knowledge-and-staff/certifications" title="Certifications" />;
}
