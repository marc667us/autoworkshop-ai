...
/**
 * /knowledge-and-staff/technician-competencies — "Technician Competencies".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/knowledge-and-staff/technician-competencies');
  return <PlannedScreen route="/knowledge-and-staff/technician-competencies" title="Technician Competencies" />;
}
