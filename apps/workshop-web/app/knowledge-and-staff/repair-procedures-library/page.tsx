...
/**
 * /knowledge-and-staff/repair-procedures-library — "Repair Procedures Library".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/knowledge-and-staff/repair-procedures-library');
  return <PlannedScreen route="/knowledge-and-staff/repair-procedures-library" title="Repair Procedures Library" />;
}
