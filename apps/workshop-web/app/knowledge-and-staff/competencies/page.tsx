...
/**
 * /knowledge-and-staff/competencies — "Competencies".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/knowledge-and-staff/competencies');
  return <PlannedScreen route="/knowledge-and-staff/competencies" title="Competencies" />;
}
