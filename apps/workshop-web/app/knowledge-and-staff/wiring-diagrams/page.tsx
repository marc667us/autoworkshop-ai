...
/**
 * /knowledge-and-staff/wiring-diagrams — "Wiring Diagrams".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/knowledge-and-staff/wiring-diagrams');
  return <PlannedScreen route="/knowledge-and-staff/wiring-diagrams" title="Wiring Diagrams" />;
}
