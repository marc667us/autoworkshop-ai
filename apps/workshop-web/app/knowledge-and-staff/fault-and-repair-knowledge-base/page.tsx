...
/**
 * /knowledge-and-staff/fault-and-repair-knowledge-base — "Fault and Repair Knowledge Base".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/knowledge-and-staff/fault-and-repair-knowledge-base');
  return <PlannedScreen route="/knowledge-and-staff/fault-and-repair-knowledge-base" title="Fault and Repair Knowledge Base" />;
}
