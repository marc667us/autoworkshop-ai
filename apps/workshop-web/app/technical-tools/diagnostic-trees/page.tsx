...
/**
 * /technical-tools/diagnostic-trees — `07.txt` pt2 §49, the technician's tree.
 *
...
export default async function Page() {
  ...
  return <PlannedScreen route="/technical-tools/diagnostic-trees" title="Diagnostic Trees" />;
}
