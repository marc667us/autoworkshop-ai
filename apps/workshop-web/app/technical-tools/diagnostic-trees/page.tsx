...
import { DiagnosticTreesScreen } from '../../_screens/diagnostic-trees-screen';

/**
 * /technical-tools/diagnostic-trees — the technician's tree (`07.txt` pt2 §49).
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/technical-tools/diagnostic-trees');
  return <DiagnosticTreesScreen />;
}
