...
/**
 * /technical-tools/fault-simulation — `07.txt` pt2 §49, the technician's tree.
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/technical-tools/fault-simulation');
  return <PlannedScreen route="/technical-tools/fault-simulation" title="Fault Simulation" />;
}
