...
/**
 * /technical-tools/repair-procedures-library — `07.txt` pt2 §49, the technician's tree.
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/technical-tools/repair-procedures-library');
  return <PlannedScreen route="/technical-tools/repair-procedures-library" title="Repair Procedures Library" />;
}
