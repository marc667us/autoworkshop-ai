...
/**
 * /technical-tools/component-locations — `07.txt` pt2 §49, the technician's tree.
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/technical-tools/component-locations');
  return <PlannedScreen route="/technical-tools/component-locations" title="Component Locations" />;
}
