...
/**
 * /technical-tools/repair-solution-simulation — `07.txt` pt2 §49, the technician's tree.
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/technical-tools/repair-solution-simulation');
  return <PlannedScreen route="/technical-tools/repair-solution-simulation" title="Repair Solution Simulation" />;
}
