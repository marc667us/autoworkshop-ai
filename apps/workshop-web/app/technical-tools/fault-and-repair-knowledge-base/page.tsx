...
/**
 * /technical-tools/fault-and-repair-knowledge-base — `07.txt` pt2 §49, the technician's tree.
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/technical-tools/fault-and-repair-knowledge-base');
  return <PlannedScreen route="/technical-tools/fault-and-repair-knowledge-base" title="Fault and Repair Knowledge Base" />;
}
