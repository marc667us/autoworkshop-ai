...
/**
 * /technical-tools/technical-service-information — `07.txt` pt2 §49, the technician's tree.
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/technical-tools/technical-service-information');
  return <PlannedScreen route="/technical-tools/technical-service-information" title="Technical Service Information" />;
}
