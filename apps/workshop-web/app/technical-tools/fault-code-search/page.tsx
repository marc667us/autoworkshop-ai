...
/**
 * /technical-tools/fault-code-search — `07.txt` pt2 §49, the technician's tree.
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/technical-tools/fault-code-search');
  return <PlannedScreen route="/technical-tools/fault-code-search" title="Fault Code Search" />;
}
