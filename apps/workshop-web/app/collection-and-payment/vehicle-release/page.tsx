...
/**
 * /collection-and-payment/vehicle-release — "Vehicle Release".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/collection-and-payment/vehicle-release');
  return <PlannedScreen route="/collection-and-payment/vehicle-release" title="Vehicle Release" />;
}
