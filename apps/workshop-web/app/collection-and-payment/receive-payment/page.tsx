...
/**
 * /collection-and-payment/receive-payment — "Receive Payment".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/collection-and-payment/receive-payment');
  return <PlannedScreen route="/collection-and-payment/receive-payment" title="Receive Payment" />;
}
