...
/**
 * /collection-and-payment/receipts — "Receipts".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/collection-and-payment/receipts');
  return <PlannedScreen route="/collection-and-payment/receipts" title="Receipts" />;
}
