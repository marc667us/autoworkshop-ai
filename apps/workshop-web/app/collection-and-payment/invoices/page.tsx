...
/**
 * /collection-and-payment/invoices — "Invoices".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/collection-and-payment/invoices');
  return <PlannedScreen route="/collection-and-payment/invoices" title="Invoices" />;
}
