...
/**
 * /collection-and-payment/ready-for-collection — "Ready for Collection".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/collection-and-payment/ready-for-collection');
  return <PlannedScreen route="/collection-and-payment/ready-for-collection" title="Ready for Collection" />;
}
