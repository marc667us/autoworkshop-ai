...
/**
 * `/settings/branches` — "Branches". Slice 6 of `COMPLETION_PLAN.md`.
 *
 * The same screen as /workshop-management/branches — the settings group's name for it.
 *
