...
/**
 * /settings/workflow-rules — "Workflow Rules".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/settings/workflow-rules');
  return <PlannedScreen route="/settings/workflow-rules" title="Workflow Rules" />;
}
