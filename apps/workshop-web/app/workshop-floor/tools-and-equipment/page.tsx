...
/**
 * /workshop-floor/tools-and-equipment — "Tools and Equipment".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/workshop-floor/tools-and-equipment');
  return <PlannedScreen route="/workshop-floor/tools-and-equipment" title="Tools and Equipment" />;
}
