...
/**
 * /workshop-floor/technicians — "Technicians".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/workshop-floor/technicians');
  return <PlannedScreen route="/workshop-floor/technicians" title="Technicians" />;
}
