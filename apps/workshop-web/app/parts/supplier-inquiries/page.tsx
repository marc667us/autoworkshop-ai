...
/**
 * /parts/supplier-inquiries — "Supplier Inquiries".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/parts/supplier-inquiries');
  return <PlannedScreen route="/parts/supplier-inquiries" title="Supplier Inquiries" />;
}
