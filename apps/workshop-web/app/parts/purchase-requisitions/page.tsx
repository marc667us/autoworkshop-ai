...
/**
 * /parts/purchase-requisitions — "Purchase Requisitions".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/parts/purchase-requisitions');
  return <PlannedScreen route="/parts/purchase-requisitions" title="Purchase Requisitions" />;
}
