...
/**
 * /vehicles/vehicle-search/<id> — detail, on the §48 reception tree.
 *
 * ⚠️ GATED ON THE PARENT LIST ROUTE, not on this one. A detail route is DYNAMIC
 * and no navigation advertises one entry per record, so "is `/vehicles/vehicle-search/<id>`
...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <VehicleDetailScreen id={id} listHref="/vehicles/vehicle-search" customerHrefBase="/customers/customer-search" />;
}
