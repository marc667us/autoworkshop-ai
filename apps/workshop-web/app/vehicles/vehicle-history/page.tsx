...
/**
 * /vehicles/vehicle-history — "Vehicle History".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/vehicles/vehicle-history');
  return <PlannedScreen route="/vehicles/vehicle-history" title="Vehicle History" />;
}
