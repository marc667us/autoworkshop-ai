...
/**
 * /reports/workshop-performance — "Workshop Performance".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/reports/workshop-performance');
  return <PlannedScreen route="/reports/workshop-performance" title="Workshop Performance" />;
}
