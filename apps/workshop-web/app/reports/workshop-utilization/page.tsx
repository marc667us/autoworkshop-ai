...
/**
 * /reports/workshop-utilization — "Workshop Utilization".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/reports/workshop-utilization');
  return <PlannedScreen route="/reports/workshop-utilization" title="Workshop Utilization" />;
}
