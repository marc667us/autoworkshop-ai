...
/**
 * `/reports/customer-service` - "Customer Service". Slice 8 of `COMPLETION_PLAN.md`.
 *
 * Renders report `customer-service`. Fourteen report routes map onto NINE distinct
...
const ROUTE = '/reports/customer-service';

export default async function Page() {
  await requireNavRoute('workshop', ROUTE);
  return <ReportScreen route={ROUTE} reportKey="customer-service" fallbackTitle="Customer Service" />;
}
