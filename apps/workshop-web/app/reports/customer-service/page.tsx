...
/**
 * /reports/customer-service — "Customer Service".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/reports/customer-service');
  return <PlannedScreen route="/reports/customer-service" title="Customer Service" />;
}
