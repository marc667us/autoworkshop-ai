...
/**
 * /reports/technician-workload — "Technician Workload".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/reports/technician-workload');
  return <PlannedScreen route="/reports/technician-workload" title="Technician Workload" />;
}
