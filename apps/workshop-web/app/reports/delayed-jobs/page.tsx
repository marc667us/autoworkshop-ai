...
/**
 * /reports/delayed-jobs — "Delayed Jobs".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/reports/delayed-jobs');
  return <PlannedScreen route="/reports/delayed-jobs" title="Delayed Jobs" />;
}
