...
/**
 * /reports/technician-productivity — "Technician Productivity".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/reports/technician-productivity');
  return <PlannedScreen route="/reports/technician-productivity" title="Technician Productivity" />;
}
