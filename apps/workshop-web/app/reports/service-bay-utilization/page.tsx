...
/**
 * /reports/service-bay-utilization — "Service-Bay Utilization".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/reports/service-bay-utilization');
  return <PlannedScreen route="/reports/service-bay-utilization" title="Service-Bay Utilization" />;
}
