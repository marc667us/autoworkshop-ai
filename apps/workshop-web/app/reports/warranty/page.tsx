...
/**
 * `/reports/warranty` - "Warranty". Slice 8 of `COMPLETION_PLAN.md`.
 *
 * Renders report `warranty`. Fourteen report routes map onto NINE distinct
...
const ROUTE = '/reports/warranty';

export default async function Page() {
  await requireNavRoute('workshop', ROUTE);
  return <ReportScreen route={ROUTE} reportKey="warranty" fallbackTitle="Warranty" />;
}
