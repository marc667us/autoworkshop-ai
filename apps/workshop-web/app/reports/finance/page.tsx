...
/**
 * `/reports/finance` - "Finance". Slice 8 of `COMPLETION_PLAN.md`.
 *
...
const ROUTE = '/reports/finance';

export default async function Page() {
  await requireNavRoute('workshop', ROUTE);
  return <ReportScreen route={ROUTE} reportKey="finance" fallbackTitle="Finance" />;
}
