...
/**
 * /parts-and-supply/procurement — "Procurement".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/parts-and-supply/procurement');
  return <PlannedScreen route="/parts-and-supply/procurement" title="Procurement" />;
}
