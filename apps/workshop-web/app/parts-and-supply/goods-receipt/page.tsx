...
/**
 * /parts-and-supply/goods-receipt — "Goods Receipt".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/parts-and-supply/goods-receipt');
  return <PlannedScreen route="/parts-and-supply/goods-receipt" title="Goods Receipt" />;
}
