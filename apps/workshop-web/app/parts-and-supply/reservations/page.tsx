...
/**
 * /parts-and-supply/reservations — "Reservations".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/parts-and-supply/reservations');
  return <PlannedScreen route="/parts-and-supply/reservations" title="Reservations" />;
}
