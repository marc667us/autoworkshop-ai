...
/**
 * /parts-and-supply/marketplace — "Marketplace".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/parts-and-supply/marketplace');
  return <PlannedScreen route="/parts-and-supply/marketplace" title="Marketplace" />;
}
