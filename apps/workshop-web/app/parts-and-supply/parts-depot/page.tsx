...
/**
 * /parts-and-supply/parts-depot — "Parts Depot".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/parts-and-supply/parts-depot');
  return <PlannedScreen route="/parts-and-supply/parts-depot" title="Parts Depot" />;
}
