...
/**
 * /parts-and-supply/suppliers — "Suppliers".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/parts-and-supply/suppliers');
  return <PlannedScreen route="/parts-and-supply/suppliers" title="Suppliers" />;
}
