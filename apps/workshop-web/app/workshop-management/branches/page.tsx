...
/**
 * /workshop-management/branches — "Branches".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/workshop-management/branches');
  return <PlannedScreen route="/workshop-management/branches" title="Branches" />;
}
