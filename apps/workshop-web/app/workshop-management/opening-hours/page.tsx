...
/**
 * /workshop-management/opening-hours — "Opening Hours".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/workshop-management/opening-hours');
  return <PlannedScreen route="/workshop-management/opening-hours" title="Opening Hours" />;
}
