...
/**
 * /workshop-management/service-categories — "Service Categories".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/workshop-management/service-categories');
  return <PlannedScreen route="/workshop-management/service-categories" title="Service Categories" />;
}
