...
/**
 * /workshop-management/service-bays — "Service Bays".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/workshop-management/service-bays');
  return <PlannedScreen route="/workshop-management/service-bays" title="Service Bays" />;
}
