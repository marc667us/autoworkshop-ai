...
/**
 * /workshop-management/roles-and-permissions — "Roles and Permissions".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/workshop-management/roles-and-permissions');
  return <PlannedScreen route="/workshop-management/roles-and-permissions" title="Roles and Permissions" />;
}
