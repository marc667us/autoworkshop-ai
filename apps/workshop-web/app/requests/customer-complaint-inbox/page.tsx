...
/**
 * /requests/customer-complaint-inbox — "Customer Complaint Inbox".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/requests/customer-complaint-inbox');
  return <PlannedScreen route="/requests/customer-complaint-inbox" title="Customer Complaint Inbox" />;
}
