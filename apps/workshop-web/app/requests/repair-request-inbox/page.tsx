...
/**
 * /requests/repair-request-inbox — "Repair Request Inbox".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/requests/repair-request-inbox');
  return <PlannedScreen route="/requests/repair-request-inbox" title="Repair Request Inbox" />;
}
