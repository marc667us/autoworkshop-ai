...
/**
 * /customer-approval/modification-requests — "Modification Requests".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/customer-approval/modification-requests');
  return <PlannedScreen route="/customer-approval/modification-requests" title="Modification Requests" />;
}
