 ...
 *
 * The §34 DEFAULT tree's route — where platform_administrator, workshop_supervisor, quality_control_inspector, storekeeper and cashier all land, because their nav ids have no tree of their own.
 *
...
const ROUTE = '/customer-reception/register-customer';
