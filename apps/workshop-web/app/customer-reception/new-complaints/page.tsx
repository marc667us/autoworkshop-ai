...
/**
 * /customer-reception/new-complaints — "New Complaints".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/customer-reception/new-complaints');
  return <PlannedScreen route="/customer-reception/new-complaints" title="New Complaints" />;
}
