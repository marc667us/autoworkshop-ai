...
/**
 * /customer-reception/appointments — "Appointments".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/customer-reception/appointments');
  return <PlannedScreen route="/customer-reception/appointments" title="Appointments" />;
}
