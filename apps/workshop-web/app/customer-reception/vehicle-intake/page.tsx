...
/**
 * /customer-reception/vehicle-intake — "Vehicle Intake".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/customer-reception/vehicle-intake');
  return <PlannedScreen route="/customer-reception/vehicle-intake" title="Vehicle Intake" />;
}
