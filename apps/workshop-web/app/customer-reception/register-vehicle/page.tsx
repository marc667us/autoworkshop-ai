...
/**
 * /customer-reception/register-vehicle
 *
 * The §34 DEFAULT tree's route, for the same roles as its sibling register-customer page.
 *
...
const ROUTE = '/customer-reception/register-vehicle';
