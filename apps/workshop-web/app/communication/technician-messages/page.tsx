...
/**
 * `/communication/technician-messages` — "Technician Messages". Slice 7 of `COMPLETION_PLAN.md`.
 *
...
const ROUTE = '/communication/technician-messages';

export default async function Page() {
  await requireNavRoute('workshop', ROUTE);
  return <MessagesScreen route={ROUTE} kind="technician" />;
}
