...
/**
 * /communication/technician-messages — "Technician Messages".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/communication/technician-messages');
  return <PlannedScreen route="/communication/technician-messages" title="Technician Messages" />;
}
