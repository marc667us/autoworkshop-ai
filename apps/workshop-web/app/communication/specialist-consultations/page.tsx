...
/**
 * /communication/specialist-consultations — "Specialist Consultations".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/communication/specialist-consultations');
  return <PlannedScreen route="/communication/specialist-consultations" title="Specialist Consultations" />;
}
