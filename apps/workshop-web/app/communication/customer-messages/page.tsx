...
/**
 * `/communication/customer-messages` — "Customer Messages". Slice 7 of `COMPLETION_PLAN.md`.
 *
...
const ROUTE = '/communication/customer-messages';

export default async function Page() {
  await requireNavRoute('workshop', ROUTE);
  return <MessagesScreen route={ROUTE} kind="customer" />;
}
