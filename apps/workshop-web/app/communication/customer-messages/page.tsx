...
/**
 * /communication/customer-messages — "Customer Messages".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/communication/customer-messages');
  return <PlannedScreen route="/communication/customer-messages" title="Customer Messages" />;
}
