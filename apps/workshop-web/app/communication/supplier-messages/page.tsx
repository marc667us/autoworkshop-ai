...
/**
 * /communication/supplier-messages — "Supplier Messages".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/communication/supplier-messages');
  return <PlannedScreen route="/communication/supplier-messages" title="Supplier Messages" />;
}
