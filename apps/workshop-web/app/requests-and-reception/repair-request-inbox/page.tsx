...
/**
 * /requests-and-reception/repair-request-inbox — "Repair Request Inbox".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/requests-and-reception/repair-request-inbox');
  return <PlannedScreen route="/requests-and-reception/repair-request-inbox" title="Repair Request Inbox" />;
}
