...
/**
 * `/requests-and-reception/customer-complaint-inbox` — a job queue.
 *
...
const ROUTE = '/requests-and-reception/customer-complaint-inbox';

export default async function Page() {
  await requireNavRoute('workshop', ROUTE);
  return <JobQueueScreen route={ROUTE} queue={JOB_QUEUES[ROUTE]} />;
}
