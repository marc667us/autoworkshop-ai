...
/**
 * /requests-and-reception/customer-complaint-inbox — "Customer Complaint Inbox".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/requests-and-reception/customer-complaint-inbox');
  return <PlannedScreen route="/requests-and-reception/customer-complaint-inbox" title="Customer Complaint Inbox" />;
}
