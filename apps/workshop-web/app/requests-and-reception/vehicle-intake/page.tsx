...
/**
 * /requests-and-reception/vehicle-intake — "Vehicle Intake".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/requests-and-reception/vehicle-intake');
  return <PlannedScreen route="/requests-and-reception/vehicle-intake" title="Vehicle Intake" />;
}
