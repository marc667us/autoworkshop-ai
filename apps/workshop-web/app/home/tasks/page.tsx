...
/**
 * /home/tasks — a real view of real job cards, narrowed to one point in the
...
export default async function Page() {
  ...
  await requireNavRoute('workshop', '/home/tasks');
  return <JobQueueScreen route="/home/tasks" queue={JOB_QUEUES['/home/tasks']} />;
}
