...
/**
 * /workshop-operations/appointments — "Appointments".
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/workshop-operations/appointments');
  return <PlannedScreen route="/workshop-operations/appointments" title="Appointments" />;
}
