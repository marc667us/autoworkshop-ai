...
/**
 * /learning/audio-guides — `07.txt` pt2 §49, the technician's tree.
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/learning/audio-guides');
  return <PlannedScreen route="/learning/audio-guides" title="Audio Guides" />;
}
