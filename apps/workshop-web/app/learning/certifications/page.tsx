...
/**
 * /learning/certifications — `07.txt` pt2 §49, the technician's tree.
 *
...
export default async function Page() {
  await requireNavRoute('workshop', '/learning/certifications');
  return <PlannedScreen route="/learning/certifications" title="Certifications" />;
}
