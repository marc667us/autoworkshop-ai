...
/**
 * /testing/submit-to-quality-control — the §49 TECHNICIAN tree — the same session, entered by its submission.
 *
...
export default async function Page() {
  ...
  return <TestingQueueScreen route="/testing/submit-to-quality-control" />;
}
