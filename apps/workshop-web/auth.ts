...
/**
 * This app's Auth.js instance — the workshop workspace.
 *
 ...
 * (`autoworkshop-workshop-web`); there is nothing per-app to configure here.
 *
 ...
 */
const instance: WorkspaceAuth = workspaceAuth('workshop');
