...
/**
 * This app's Auth.js instance — the admin workspace.
 *
 ...
 * (`autoworkshop-admin-web`); there is nothing per-app to configure here.
 *
 ...
 */
const instance: WorkspaceAuth = workspaceAuth('admin');
