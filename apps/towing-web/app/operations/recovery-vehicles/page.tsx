...
import { RecoveryVehiclesScreen } from '../../_screens/recovery-vehicles-screen';

/**
 * `/operations/recovery-vehicles` — the truck fleet.
 *
...
export default async function Page() {
  await requireNavRoute('towing', '/operations/recovery-vehicles');
  return <RecoveryVehiclesScreen />;
}
