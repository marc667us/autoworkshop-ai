...
import { RecoveriesScreen } from '../../_screens/recoveries-screen';

/**
 * `/operations/completed-recoveries` — finished and cancelled recoveries.
 *
...
export default async function Page() {
  await requireNavRoute('towing', '/operations/completed-recoveries');
  return <RecoveriesScreen scope="completed" />;
}
