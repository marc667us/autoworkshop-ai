...
/**
 * This app's Auth.js instance — the towing workspace.
 *
 ...
 * (`autoworkshop-towing-web`); there is nothing per-app to configure here.
 *
 ...
 */
const instance: WorkspaceAuth = workspaceAuth('towing');
