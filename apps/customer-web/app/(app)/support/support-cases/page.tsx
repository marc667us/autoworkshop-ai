...
/**
 * /support/support-cases — `01 (1).txt` §33, the customer workspace.
 *
...
export default async function Page() {
  await requireNavRoute('customer', '/support/support-cases');
  return <PlannedScreen route="/support/support-cases" title="Support Cases" />;
}
