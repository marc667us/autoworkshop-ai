...
/**
 * /settings/authorized-drivers — `01 (1).txt` §33, the customer workspace.
 *
...
export default async function Page() {
  await requireNavRoute('customer', '/settings/authorized-drivers');
  return <PlannedScreen route="/settings/authorized-drivers" title="Authorized Drivers" />;
}
