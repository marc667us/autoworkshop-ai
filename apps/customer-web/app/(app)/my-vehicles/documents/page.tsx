...
/**
 * /my-vehicles/documents — `01 (1).txt` §33, the customer workspace.
 *
...
export default async function Page() {
  await requireNavRoute('customer', '/my-vehicles/documents');
  return <PlannedScreen route="/my-vehicles/documents" title="Vehicle Documents" />;
}
