...
/**
 * /my-vehicles/maintenance-schedule — `01 (1).txt` §33, the customer workspace.
 *
...
export default async function Page() {
  await requireNavRoute('customer', '/my-vehicles/maintenance-schedule');
  return <PlannedScreen route="/my-vehicles/maintenance-schedule" title="Maintenance Schedule" />;
}
