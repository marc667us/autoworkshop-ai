...
import { MyQuotationsScreen } from '../../../_screens/my-quotations-screen';

/**
 * /payments/quotations — `01 (1).txt` §33, the customer workspace.
 *
 * Slice 12: this was a signpost until the customer could reach their own
 * records. It is a real screen now — see `my-quotations-screen.tsx`.
 *
...
export default async function Page() {
  ...
  await requireNavRoute('customer', '/payments/quotations');
