...
import { MyInvoicesScreen } from '../../../_screens/my-invoices-screen';

/**
 * /payments/invoices — `01 (1).txt` §33, the customer workspace.
 *
 * Slice 12: this was a signpost until the customer could reach their own
 * records. It is a real screen now — see `my-invoices-screen.tsx`.
 *
...
export default async function Page() {
  ...
  await requireNavRoute('customer', '/payments/invoices');
