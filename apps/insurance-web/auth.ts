...
/**
 * This app's Auth.js instance — the insurance workspace.
 *
 ...
 * (`autoworkshop-insurance-web`); there is nothing per-app to configure here.
 *
 ...
 */
const instance: WorkspaceAuth = workspaceAuth('insurance');
